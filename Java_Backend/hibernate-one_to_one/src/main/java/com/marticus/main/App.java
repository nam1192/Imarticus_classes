...
//Many to Many
				...
				Set<Books> bookName = new HashSet<Books>();
				bookName.add(new Books("JAVA"));
				bookName.add(new Books(".NET"));
				
				Library s3 = new Library("RON");
				session.save(s3);
				
				Set<Books> bookName1 = new HashSet<Books>();
				bookName1.add(new Books("PYTHON"));
				bookName1.add(new Books(".NET"));
				
				Library s4 = new Library("MON");
				session.save(s4);
